...
import { validateLandscapeFixtures } from '@/lib/landscape/fixtures';

export const runtime = 'nodejs';
export const dynamic = 'force-dynamic';

const KEY = 'landscapeFixtures';

// Public read: the landscape estimator fetches the effective outdoor catalogue
// on load. Degrades to empty (= built-in defaults) if the DB is unreachable.
...
export async function POST(req: Request) {
  ...
  const err = validateLandscapeFixtures(fixtures);
